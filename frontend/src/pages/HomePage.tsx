...
export const HomePage: React.FC<HomePageProps> = ({ onNavigate }) => {
  ...
  useEffect(() => {
    const handleKeyDown = (e: KeyboardEvent) => {
      if (e.key === 'Escape' && isHeroFormOpen) {
  ...
  useEffect(() => {
    if (isHeroFormOpen && window.innerWidth < 1024) {
  ...
  const BoletinPill: React.FC<{ orientation?: 'horizontal' | 'vertical' }> = ({ orientation = 'horizontal' }) => {
        ...
        <div className="max-w-[1280px] mx-auto relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start lg:min-h-[570px]">
            <div className="lg:col-span-7 space-y-6">
              ...
              <div className="space-y-3 pt-1 pl-1">
                ...
                <div className="lg:hidden flex justify-center pt-2">
                  <BoletinPill orientation="horizontal" />
                </div>
              </div>
            </div>
            ...
            <div className="hidden lg:flex lg:col-span-5 justify-end lg:min-h-[570px]">
              {!isHeroFormOpen ? (
                <BoletinPill orientation="vertical" />
              ) : (
